function open6Table() {
    ...
    var url = "sixTable.html?player1=" + player1 + "&player2=" + player2 + "&player3=" + player3 + "&player4=" + player4 + "&player5=" + player5 + "&player6=" + player6;
  ...
  function addRow() {
    ...
    newRow.innerHTML = "<td><input value=''></td><td><input value=''></td><td><input value=''></td><td><input value=''></td><td><input value=''><td><input value=''></td></td>";
